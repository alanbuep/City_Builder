 ...
 */
// v5: territorio inicial con la MITAD derecha bloqueada (3 de 6 columnas) a
// conquistar. (v4: franja lateral; v3: paisaje único.) Las partidas previas se
// descartan al cargar y arranca una ciudad nueva.
