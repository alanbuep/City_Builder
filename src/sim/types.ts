...
export const TILE_DEF: Record<TileType, TileDef> = {
  ...
  [TileType.FactorySmall]: { cost: 80, color: 0xe65100, height: 0.8, upkeep: 1, jobs: 20, build: { ladrillo: 8, cemento: 4 } },
  [TileType.FactoryMedium]: { cost: 300, color: 0xe65100, height: 1.2, upkeep: 3, size: 2, jobs: 90, build: { ladrillo: 20, cemento: 12, madera: 8 } },
  [TileType.FactoryLarge]: { cost: 700, color: 0xbf360c, height: 1.7, upkeep: 6, size: 3, jobs: 220, build: { ladrillo: 30, cemento: 20, acero: 10 } },
  ...
  [TileType.Police]: { cost: 200, color: 0x1565c0, height: 0.9, upkeep: 4, service: { radius: 5, strength: 1.0, capacity: 250 }, build: { ladrillo: 10, cemento: 6 } },
  [TileType.Fire]: { cost: 200, color: 0xc62828, height: 0.9, upkeep: 4, service: { radius: 5, strength: 1.0, capacity: 250 }, build: { ladrillo: 10, cemento: 6 } },
  ...
  [TileType.PowerPlant]: { cost: 500, color: 0xfdd835, height: 1.5, upkeep: 6, size: 2, produces: { kind: 'power', amount: 400 }, build: { cemento: 20, ladrillo: 12 } },
  [TileType.WaterTower]: { cost: 300, color: 0x29b6f6, height: 1.3, upkeep: 4, produces: { kind: 'water', amount: 350 }, build: { cemento: 12, ladrillo: 6 } },
  [TileType.GasPlant]: { cost: 350, color: 0xff7043, height: 1.2, upkeep: 4, produces: { kind: 'gas', amount: 320 }, build: { cemento: 12, ladrillo: 8 } },

  [TileType.ShoppingMall]: { cost: 400, color: 0x00897b, height: 1.1, upkeep: 5, size: 2, shopJobs: 70, amenity: { radius: 3, strength: 0.4 }, build: { ladrillo: 25, cemento: 15 } },
  [TileType.Hotel]: { cost: 450, color: 0xd81b60, height: 1.8, upkeep: 5, size: 2, shopJobs: 50, amenity: { radius: 5, strength: 0.8 }, build: { ladrillo: 25, cemento: 18, madera: 10 } },
  [TileType.OfficeTower]: { cost: 500, color: 0x3949ab, height: 2.6, upkeep: 6, shopJobs: 100, build: { cemento: 25, ladrillo: 15, madera: 10 } },
  [TileType.TechPark]: { cost: 700, color: 0x00acc1, height: 1.0, upkeep: 7, size: 2, jobs: 150, amenity: { radius: 3, strength: 0.5 }, build: { ladrillo: 20, cemento: 15, madera: 10 } },
  ...
  [TileType.University]: { cost: 500, color: 0x6d4c41, height: 1.3, upkeep: 8, size: 2, education: { radius: 7, strength: 1.6, capacity: 800 }, build: { ladrillo: 25, cemento: 15, madera: 12 } },
  [TileType.Hospital]: { cost: 500, color: 0xe57373, height: 1.3, upkeep: 8, size: 2, health: { radius: 7, strength: 1.6, capacity: 800 }, build: { ladrillo: 25, cemento: 18 } },
  ...
  [TileType.Market]: { cost: 400, color: 0x43a047, height: 1.0, upkeep: 5, size: 2, shopJobs: 40, food: { radius: 7, strength: 1.2, capacity: 800 }, amenity: { radius: 2, strength: 0.2 }, build: { ladrillo: 18, cemento: 12 } },
  ...
  [TileType.Kiosk]: { cost: 80, color: 0x26a69a, height: 0.5, upkeep: 1, shopJobs: 6, build: { madera: 4 } },
  ...
  [TileType.Dealership]: { cost: 450, color: 0x7986cb, height: 0.9, upkeep: 5, size: 2, shopJobs: 50, amenity: { radius: 2, strength: 0.2 }, build: { cemento: 15, ladrillo: 12, madera: 8 } },
